...
const LoginPage = () => {
  ...
  const { login, forgotPassword, loginWithGoogle, currentUser } = useAuth();
  const navigate = useNavigate();

  // Redirecionar se o usuário já estiver autenticado
  useEffect(() => {
    if (currentUser) {
      console.log("Usuário autenticado detectado na LoginPage:", currentUser);
      navigate("/dashboard");
    }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="bg-blue-700 p-6">
          ...
          <p className="text-blue-100 text-center mt-2">Progressão Funcional</p>
        </div>
